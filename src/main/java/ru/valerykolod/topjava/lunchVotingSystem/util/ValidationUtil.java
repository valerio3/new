...
import ru.valerykolod.topjava.lunchVotingSystem.model.AbstractEntity;
import ru.valerykolod.topjava.lunchVotingSystem.util.exception.ErrorType;
...
public class ValidationUtil {
    ...
    public static void checkNotFoundWithId(int id, boolean found) {
